    ...
    <div className="space-y-8">
      <section>
        ...
        <form action={createBulletinAction} className="space-y-2 rounded-xl border border-line bg-white p-4">
          <input name="title" placeholder="Title" className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
          <textarea name="body" rows={3} placeholder="Bulletin body" className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
          <input name="destination" placeholder="Destination (optional, e.g. CA)" className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
      ...
      <section>
        ...
        <form action={createRegUpdateAction} className="space-y-2 rounded-xl border border-line bg-white p-4">
          <input name="destination" placeholder="Destination (CA/UK/AU/MY)" className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
          <textarea name="summary" rows={2} placeholder="What changed (form version, requirement, threshold…)" className="w-full rounded-lg border border-line px-3 py-2 text-sm" />
          <input type="date" name="effectiveDate" className="rounded-lg border border-line px-3 py-2 text-sm" />
