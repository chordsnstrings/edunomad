  ...
  return (
    <div>
      ...
      <form action={escalateAction} className="space-y-2">
        <textarea name="reason" rows={4} required placeholder={t("parent.escalate.placeholder")} className="w-full rounded-lg border border-line px-3 py-2.5 text-sm outline-none focus:border-navy" />
